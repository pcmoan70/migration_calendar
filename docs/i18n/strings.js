...
window.GeoI18N = (function () {
  ...
  var STRINGS = {
    en: {
      ...
      "mode.field": "Field checklist (click map)",
      "btn.clear": "Clear",
      "act.heard": "Heard",
      "act.flying": "Flying",
      "act.feeding": "Feeding",
    ...
    sv: {
      ...
      "mode.field": "Fältchecklista (klicka på kartan)",
      "btn.clear": "Rensa",
      "act.heard": "Hörd",
      "act.flying": "Flygande",
      "act.feeding": "Födosök",
    ...
    de: {
      ...
      "mode.field": "Feld-Checkliste (auf Karte klicken)",
      "btn.clear": "Leeren",
      "act.heard": "Gehört",
      "act.flying": "Fliegend",
    ...
    es: {
      ...
      "mode.field": "Lista de campo (clic en el mapa)",
      "btn.clear": "Vaciar",
      "act.heard": "Oído",
      "act.flying": "Volando",
    ...
    fr: {
      ...
      "mode.field": "Liste de terrain (cliquez sur la carte)",
      "btn.clear": "Effacer",
      "act.heard": "Entendu",
      "act.flying": "En vol",
    ...
    nl: {
      ...
      "mode.field": "Veldchecklist (klik op de kaart)",
      "btn.clear": "Wissen",
      "act.heard": "Gehoord",
      "act.flying": "Vliegend",
    ...
    no: {
      ...
      "mode.field": "Feltsjekkliste (klikk på kartet)",
      "btn.clear": "Tøm",
      "act.heard": "Hørt",
      "act.flying": "Flygende",
    ...
    it: {
      ...
      "mode.field": "Lista da campo (clicca sulla mappa)",
      "btn.clear": "Svuota",
      "act.heard": "Sentito",
      "act.flying": "In volo",
